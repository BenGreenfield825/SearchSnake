...
class snake(object):
    ...
    def moveAuto(self, keys):   # use this move method when directions are generated by successor method
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                pygame.quit()
                ...
                if wallX.pos != nextState:   # if nextState we generated is not a wall
                    if nextState != current_pos:
                        if nextState not in successors:
                            directionX = 0
                            if movesX == 1:
                                directionX = pygame.K_RIGHT
                            else:
                                directionX = pygame.K_LEFT
...
def main():
    ...
    while flag:
        ...
        # keyPresses = [pygame.K_UP, pygame.K_DOWN, pygame.K_LEFT, pygame.K_RIGHT]
